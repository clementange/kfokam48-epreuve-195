...
- **Le seed est une migration Flyway**, pas un script à lancer à la main : les données de démonstration arrivent avec le schéma, au premier démarrage, et sont donc reproductibles et versionnées comme lui.
